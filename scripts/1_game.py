...
mx.pre_init()
mx.init()
sound1 = pygame.mixer.Sound("../assets/music/bgm/music1.mp3")
sound4 = pygame.mixer.Sound("../assets/music/soundeffects/gunfire.wav")

sound1.set_volume(0.05)
sound4.set_volume(0.05)
sound3 = pygame.mixer.Sound("../assets/music/soundeffects/lostmusic.wav")
sound3.set_volume(0.2)
sound2 = pygame.mixer.Sound("../assets/music/soundeffects/boom.wav")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        myimage = pygame.image.load("../assets/images/tri3.png")
...
class Gun(pygame.sprite.Sprite):
    def __init__(self,tupple):
        ...
        myimage = pygame.image.load("../assets/images/gun.png")
        # self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("../assets/images/bull2.png").convert()
...
# conn.execute(q)
# q = """SELECT max(score) from scores;"""
